...
class AdmsViewTopo extends Conn
{
    ...
    public function viewTopo() {
        ...
        $query_home_topo = "SELECT id, titulo_topo, subtitulo_topo, text_btn_topo, link_btn_topo, imagem_topo FROM homes_topos LIMIT 1";
    ...
    public function editTopo($dados) {
        $this->dados = $dados;
        $this->conn = $this->connect();
        $query_topo = "UPDATE homes_topos SET titulo_topo=:titulo_topo, subtitulo_topo=:subtitulo_topo, text_btn_topo=:text_btn_topo, link_btn_topo=:link_btn_topo, modified=NOW() WHERE id=:id";
